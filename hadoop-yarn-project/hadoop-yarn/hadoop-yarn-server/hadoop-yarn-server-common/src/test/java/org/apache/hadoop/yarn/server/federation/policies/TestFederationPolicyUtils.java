...
public class TestFederationPolicyUtils {
  ...
  public void testGetApplicationPolicyTag() {
    Assert.assertEquals(null, FederationPolicyUtils.getApplicationPolicyTag(null));
    ...
    Assert.assertEquals(null, FederationPolicyUtils.getApplicationPolicyTag(context));
